   ...
   public class Program
    {
        static void Main(string[] args)
        {
            ...
            CheckingAcct checking = new CheckingAcct("Ahror", "Mamadiev", 2500.0m);

            // Create the Savings Account with interest and initial balance
            SavingsAcct saving = new SavingsAcct("Aylin", "Samieva", 0.025m, 1000.0m);
            ...
            // "Checking owner: Ahror Mamadiev"
            // "Savings owner: Aylin Samieva"
